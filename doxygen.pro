...
unix:LIBS += -L/usr/lib/qtcreator -L/usr/lib/qtcreator/plugins/Nokia -L/usr/lib/qt4
win32:LIBS += -LC:/Qt/4.6.0-rc1/lib -LC:/Qt/dev/qt-creator-src/lib/qtcreator/plugins/Nokia -LC:/Qt/dev/qt-creator-src/lib/qtcreator
