<plugin name="Doxygen" version="0.3.1" compatVersion="2.1.84">
    <vendor>Kofee</vendor>
    <copyright>(C) 2009-2011 Kevin Tanguy (kofee@kofee.org)</copyright>
    <license>
...
Can launch doxywizard and doxygen through menu or shortcut from your Qt Creator project.
    ...
    <dependencyList>
        <dependency name="Core" version="2.1.84"/>
        <dependency name="CppEditor" version="2.1.84"/>
        <dependency name="CppTools" version="2.1.84"/>
        <dependency name="Locator" version="2.1.84"/>
        <dependency name="ProjectExplorer" version="2.1.84"/>
        <dependency name="TextEditor" version="2.1.84"/>
    </dependencyList>
</plugin>
